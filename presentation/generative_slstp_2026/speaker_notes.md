...
## 3. We compared three model families and used conditional diffusion (1:00)
...
## 5. DDIM matched expression and reduced separability (1:05)
...
## 6. Synthetic profiles entered the analysis in five different ways (1:00)
...
## 7. Pooling tissues hid useful signal (1:00)
...
## 8. Synthetic guidance changed ranking, not statistical evidence (0:55)
...
## 9. Annotation separates recovery from hypothesis extension (1:05)
...
## 10. Thymus points to lower proliferative renewal (1:15)
...
## 11. Soleus reinforces a mitochondrial and lipid program (1:05)
...
## 12. Kidney adds a focused signal; other tissues are exploratory (0:55)
...
## 13. Synthetic data helped most as a tissue-specific prior (0:45)
