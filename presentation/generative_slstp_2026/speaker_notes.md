...
## 2. Learn how spaceflight changes living systems (0:35)
...
## 4. Study identity dominates the expression structure (0:25)
...
## 5. MOBER tries to remove study identity (0:35)
...
## 6. MOBER reduces study separation, but FLT and GC still overlap (0:30)
...
## 7. expiMap assigns each latent feature to a known pathway (0:35)
...
## 8. Program scores summarize pathway changes within one tissue (0:45)
...
## 9. Each program was compared with prior literature (0:30)
...
## 10. Five tissues showed recurring pathway patterns (0:55)
...
## 11. What is synthetic transcriptomics? (0:25)
...
## 12. Diffusion: denoise from noise (0:30)
...
## 13. Conditional WGAN-GP: generator versus critic (0:30)
...
## 14. Building the RNA-seq generator (0:45)
...
## 15. Diffusion best reproduced the measured expression distribution (0:45)
...
## 16. Diffusion learns tissue structure from noise (0:25)
...
## 17. FLT and GC overlap in the global PCA view (0:25)
...
## 18. Tissue and study structure dominate the PCA space (0:30)
...
## 19. Does adding synthetic data improve FLT vs GC prediction? (0:30)
...
## 20. Real + synthetic vs real-only balanced accuracy across 27 tissues (0:45)
...
## 21. Compare what each classifier finds important (0:30)
...
## 22. We compared feature importance at three levels (0:35)
...
## 23. The three analyses retained different types of results (0:35)
...
## 24. All three analyses found candidates in thymus, skin and spleen (0:40)
...
## 25. Feature selection and literature review answer separate questions (0:35)
...
## 26. Thymus: all three analyses point to lower cell-cycle activity in flight (0:45)
...
## 27. Skin and spleen show different flight-associated patterns (0:45)
...
## 28. What the models can and cannot tell us (0:30)
