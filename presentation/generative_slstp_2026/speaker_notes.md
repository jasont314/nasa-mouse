...
## 12. Synthetic guidance changed ranking, not statistical evidence (0:45)
...
## 13. Selection and literature are separate dimensions (0:50)
...
## 14. The screen covered all 27 completed tissue analyses (0:35)
...
## 15. Ten tissue analyses contained synthetic-informed genes (0:40)
...
## 16. Thymus points to lower proliferative renewal (1:00)
...
## 17. Soleus reinforces a mitochondrial and lipid program (0:55)
...
## 18. Additional tissues produced distinct hypotheses (0:35)
...
## 19. Eye, adrenal and muscle-group results remain tissue-specific (0:35)
...
## 20. Synthetic data worked best as a tissue-specific prior (0:35)
