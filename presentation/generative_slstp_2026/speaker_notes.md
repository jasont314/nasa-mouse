...
## 10. Pooling tissues hid useful signal (0:50)
...
## 11. Synthetic guidance changed ranking, not statistical evidence (0:45)
...
## 12. Selection and literature are separate dimensions (0:50)
...
## 13. The screen covered all 27 completed tissue analyses (0:35)
...
## 14. Ten tissue analyses contained synthetic-informed genes (0:40)
...
## 15. Thymus points to lower proliferative renewal (1:00)
...
## 16. Soleus reinforces a mitochondrial and lipid program (0:55)
...
## 17. Additional tissues produced distinct hypotheses (0:35)
...
## 18. Eye, adrenal and muscle-group results remain tissue-specific (0:35)
...
## 19. Synthetic data worked best as a tissue-specific prior (0:35)
