...
def parse_args() -> argparse.Namespace:
    ...
    prepare_parser.add_argument(
        "--config", default="configs/generative/diffusion/archs4_mouse_paper_parity.yaml"
    )
    ...
    conditional_prepare.add_argument(
        "--config",
        default="configs/generative/diffusion/osdr_pooled_flt_gc_paper_architecture.yaml",
    )
