...
from .annotate_importance_literature import (
    write_tables as write_importance_literature_tables,
)
...
WGAN_DIR = (
    ROOT
    / "outputs/generative/benchmark/runs/vinas_wgan_gp/"
    "osdr_matched_study_conditioned_seed2020/evaluation/matched_validation"
)
HARMONIZATION_DIR = (
    ROOT / "outputs/generative/benchmark/summary/liver_harmonization"
)
COLORS = {
    "navy": "#23445D",
    "teal": "#17807E",
...
def figure_3_thymus(tables: dict[str, pd.DataFrame]) -> None:
    ...
    fig.suptitle(
        "Synthetic-informed thymus genes point to a flight-lower mitotic program",
        x=0.02,
        ha="left",
        fontsize=11,
        weight="bold",
...
def build_manifest() -> None:
    tracked_inputs = [
        ...
        GROUPED_IMPORTANCE_DIR / "eligible_synthetic_pathways.tsv.gz",
        GROUPED_IMPORTANCE_DIR / "top_nonredundant_pathways.tsv",
        LANDMARK_PANEL,
        WGAN_DIR / "summary.json",
        WGAN_DIR / "calibrated_repeat_metrics.tsv",
        HARMONIZATION_DIR / "independent_metrics.tsv",
        ROOT / "configs/generative/benchmark/preprocessing_profiles.yaml",
        ROOT / "configs/generative/benchmark/model_profiles.yaml",
        ROOT / "configs/generative/benchmark/experiment_matrix.yaml",
    ]
    rows = []
...
def main() -> None:
    ...
    write_importance_literature_tables()
