...
LATENT_CONFIGS = (
    LatentConfig(
        "thymus",
        ROOT
        / "outputs/expimap_archs4_reference_osdr_query_thymus/tutorial_hvg_2000/reference_nb_400epoch_seed2020/trained_input_with_scores.h5ad",
        ROOT
        / "outputs/expimap_archs4_reference_osdr_query_thymus/tutorial_hvg_2000/query_nb_250epoch_seed2020/mapped_query_with_scores.h5ad",
        "R-MMU-73894_DNA_REPAIR",
    ),
    LatentConfig(
        "skin",
        ROOT
        / "outputs/expimap_archs4_reference_osdr_query_skin/tutorial_hvg_2000/reference_nb_400epoch_seed2020/trained_input_with_scores.h5ad",
        ROOT
        / "outputs/expimap_archs4_reference_osdr_query_skin/tutorial_hvg_2000/query_nb_250epoch_seed2020/mapped_query_with_scores.h5ad",
        "R-MMU-421270_CELL_CELL_JUNCTION_ORGANIZATION",
    ),
    LatentConfig(
        "liver",
        ROOT
        / "outputs/expimap_archs4_reference_osdr_query_liver/tutorial_hvg_2000/reference_nb_400epoch_seed2020/trained_input_with_scores.h5ad",
        ROOT
        / "outputs/expimap_archs4_reference_osdr_query_liver/tutorial_hvg_2000/query_nb_250epoch_seed2020_primary_deduplicated/mapped_query_with_scores.h5ad",
        "R-MMU-2132295_MHC_CLASS_II_ANTIGEN_PRESENTATION",
    ),
    LatentConfig(
        "spleen",
        ROOT
        / "outputs/expimap_archs4_reference_osdr_query_spleen/reassessment_hvg_2000/reference_nb_400epoch_seed2020/trained_input_with_scores.h5ad",
        ROOT
        / "outputs/expimap_archs4_reference_osdr_query_spleen/reassessment_hvg_2000/query_nb_250epoch_seed2020/mapped_query_with_scores.h5ad",
