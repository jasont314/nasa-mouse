...
DEFAULT_METADATA = "outputs/expimap/runs/direct/skeletal_muscle/input/profile_metadata.tsv"
DEFAULT_COUNTS_DIR = "data/osdr_api/counts"
DEFAULT_PATHWAY_SCORES = (
    "outputs/expimap/runs/reference_query/skeletal_muscle/"
    "query_nb_allref_50epoch/query_pathway_scores.tsv"
)
DEFAULT_OUTPUT_DIR = "outputs/expimap/analyses/skeletal_muscle_targeted_modules"
