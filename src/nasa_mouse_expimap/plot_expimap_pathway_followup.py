...
def run(args) -> None:
    ...
    for tissue in args.tissue:
        base_dir = Path(
            f"outputs/expimap/runs/reference_query/{tissue}/query_nb_allref_50epoch"
        )
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="outputs/expimap/analyses/pathway_followup_all_reference")
