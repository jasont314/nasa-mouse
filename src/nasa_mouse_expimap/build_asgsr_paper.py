...
CONFIGS = (
    ModelConfig(
        ...
        display_name="Thymus",
        run_dir=ROOT
        / "outputs/expimap/runs/reference_query/thymus/tutorial_hvg_2000/query_nb_250epoch_seed2020",
        input_manifest=ROOT
        / "outputs/expimap/runs/reference_query/thymus/tutorial_hvg_2000/input/tutorial_hvg_input_manifest.json",
    ...
    ModelConfig(
        ...
        display_name="Skin",
        run_dir=ROOT
        / "outputs/expimap/runs/reference_query/skin/tutorial_hvg_2000/query_nb_250epoch_seed2020",
        input_manifest=ROOT
        / "outputs/expimap/runs/reference_query/skin/tutorial_hvg_2000/input/tutorial_hvg_input_manifest.json",
        reference_summary=ROOT
    ...
    ModelConfig(
        ...
        display_name="Liver",
        run_dir=ROOT
        / "outputs/expimap/runs/reference_query/liver/tutorial_hvg_2000/query_nb_250epoch_seed2020_primary_deduplicated",
        input_manifest=ROOT
        / "outputs/expimap/runs/reference_query/liver/tutorial_hvg_2000/input/tutorial_hvg_input_manifest.json",
        reference_summary=ROOT
        ...
        / "outputs/expimap/runs/reference_query/liver/tutorial_hvg_2000/query_nb_250epoch_seed2020",
    ),
    ModelConfig(
        tissue="soleus",
        display_name="Soleus",
        run_dir=ROOT
        / "outputs/expimap/runs/muscle_groups/combined_min8/tutorial_hvg_soleus_2000/query_nb_250epoch_seed2020",
        input_manifest=ROOT
        / "outputs/expimap/runs/muscle_groups/combined_min8/tutorial_hvg_soleus_2000/input/tutorial_hvg_input_manifest.json",
        reference_summary=ROOT
...
def run() -> None:
    ...
    from nasa_mouse_expimap.review_expanded_pathway_screen import (
