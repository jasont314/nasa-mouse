---
title: "RACARA sample code_AE_col"
...
#length(col_FLT[which(km4$cluster==1),1]) #226
#length(col_FLT[which(km4$cluster==2),1]) #22939
#length(col_FLT[which(km4$cluster==3),1]) #1290
#length(col_FLT[which(km4$cluster==4),1]) #43
```

```{r}
col_FLT_c1<-col_FLT[which(km4$cluster==1),]
#AE
