...
The GLARE submodule points at the `jasont314/Plants_AWG` fork commit containing
the `hpt.py` runtime fix. `patches/glare-hpt-runtime.patch` is kept as a
reference copy of that change: direct script execution works, MatrixMarket input
