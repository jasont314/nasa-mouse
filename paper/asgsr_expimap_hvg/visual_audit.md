...
The main set exposes the workflow and model scope, tissue-specific reference-query support, project and complete-training effects, orthogonal directional checks, retained-pathway member-gene support, skin protocol context, and a qualified tissue-state synthesis. Figure 6 explicitly separates observed lower scores from hypotheses with dotted interpretive links and states the bulk-tissue, pathway-inhibition, and cell-composition boundaries in the figure and caption. Figure S9 exposes individual sample distributions without treating samples as independent mission replicates. The broader process summary is a regenerable analysis artifact under `outputs/expimap/analyses/publication_process_summary/`. No generated biological artwork is used in the manuscript package.
