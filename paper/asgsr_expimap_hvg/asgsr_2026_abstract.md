...
GitHub Copilot assisted with code generation, data processing and analysis, interpretation, visualization generation, and text editing. Jason Trinh reviewed and verified all included AI-assisted output.
