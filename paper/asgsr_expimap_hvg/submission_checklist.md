# ASGSR 2026 submission checklist

Verified against the official [ASGSR 2026 abstract instructions](https://asgsr.org/call-for-abstracts-2026/) and [pre-conference schedule](https://asgsr.org/42nd-annual-asgsr-pre-conference-schedule-2/) on July 13, 2026.
...
- [ ] Register by September 30, 2026, if the abstract is accepted.

The ASGSR page states that the 2026 meeting is December 2-5, 2026, at the Crystal Gateway Marriott in Crystal City, Virginia. An earlier ASGSR news post listed May 31, but the detailed submission page and current conference schedule list June 14; those current pages are used here. The schedule also lists a late-breaking call in July with a deadline in August, but an active late-breaking page must be confirmed before relying on that route.
