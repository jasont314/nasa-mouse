...
For a manuscript explicitly focused on tissues with interpretable results, the defensible positive core is thymus, skin, liver, and spleen. Spleen should replace soleus in the positive-result narrative. Kidney can be included as a clearly labeled secondary result because its structural-growth axis is coherent but lacks the conventional FDR support of the spleen core. Soleus should move to the screening or supplementary sensitivity analysis rather than be removed from the record. Lung and retina remain the defensible negative screens.
