...
> Read `/media/volume/mouse/nasa/nasa-mouse/PRESENTATION_HANDOFF.md`, inspect the referenced files, and continue from the current repository state. Do not reset or stage unrelated worktree changes. Push after each new commit.
