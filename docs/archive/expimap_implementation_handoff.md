# Archived expiMap and scArches implementation handoff

This file preserves early setup and run history, including machine-specific
paths. Use the root README, `outputs/COMMANDS.md`, and
`paper/asgsr_expimap_hvg/README.md` for the current workflow.
