# Legacy OSDR Mouse Bulk RNA-seq FLT/GC Counts By Tissue

This is a historical inventory made from an older integrated local matrix. It
is retained for provenance but is not an input to the current workflows. The
current API-derived inventory is under
